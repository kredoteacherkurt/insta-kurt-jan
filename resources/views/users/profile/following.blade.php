        ...
        @if ($user->following->isNotEmpty())
            <div class="row justify-content-center">
                <div class="col-4">
                    ...
                    {{-- debug  $user->following as $following --}}
                    {{-- <p>{{ $following }}</p> --}}
                    {{-- result : {"follower_id":1,"following_id":2} --}}
                            ...
                            <div class="col-auto">
                                <a href="{{ route('profile.show', $following->following_id) }}" class="text-decoration-none text-dark">
                                    @if ($following->following->avatar)
                                        <img src="{{ $following->following->avatar }}" alt="{{ $following->following->avatar }}" class="rounded-circle avatar-sm">
                                    @else
